          ...
          <div className="weather dailycard" key={`main_${i}`}>
            ...
            <div style={{ display: "flex", justifyContent: "center" }}>
              ...
              <h2 key={`h2_${i}`} style={{ margin: "auto 5px" }}>
                {kelvinToFahrenheit(Math.round(obj.main.temp))}
                <sup>°F</sup>
              </h2>
            </div>
            <div style={{ display: "flex", justifyContent: "center" }}>
              <h2 key={`h4_${i}`} style={{ margin: "auto 5px" }}>
                {kelvinToFahrenheit(Math.round(obj.main.temp_max))}
                <sup>°F</sup>
              </h2>
              <h2
                key={`h5_${i}`}
              ...
              >
                {kelvinToFahrenheit(Math.round(obj.main.temp_min))}
                <sup>°F</sup>
              </h2>
            </div>
        ...
        <div className="currentTemp">
          <div style={{ display: "flex", flexWrap: "wrap", gap: "45px" }}>
            ...
            <h2 className="degreeHead">
              {kelvinToFahrenheit(Math.round(currentDailyWeather.main.temp))}
